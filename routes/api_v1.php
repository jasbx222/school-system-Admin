...
use App\Http\Controllers\Schools\v1\account\AccountController;
use App\Http\Controllers\Schools\v1\auth\AuthController;
use App\Http\Controllers\Schools\v1\class\ClassController;
use App\Http\Controllers\Schools\v1\expenses\payment_vouchers\PaymentVoucherController;
...
Route::middleware(['auth:sanctum', 'check_expiry'])->group(
    function () {
        ...
        //الارباح والخسائر
        Route::get('get_profit_loss', [AccountController::class, 'get_profit_loss']);
    }
);
